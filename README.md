...
| 🗓️ **Raspored nastave** | Fakultetski tjedni raspored predavanja i vježbi (po danima, dvoranama i nastavnicima), filtriranje, administratorski izvještaj o kolizijama i iskorištenosti dvorana, **evolucijsko generiranje rasporeda** koje kolegije odabrane godine studija smješta u termine uz najmanje kolizija studenata (s krivuljom konvergencije) te **usporedba svih 6 metaheuristika** na istom problemu |
| 📝 **Provjere znanja** | Definiranje provjera, rezervacija dvorana, prijava studenata, **evolucijsko raspoređivanje po dvoranama**, **evolucijsko generiranje rasporeda ispita** (bez kolizija studenata, uz usporedbu s povijesnim rasporedom), usporedba 6 algoritama s krivuljama konvergencije, dodjela dežurnih asistenata, objava, dijagram toka |
