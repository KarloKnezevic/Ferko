...
public class ZauzmiDvorane2 {
	...
	public static void main(String[] args) throws IOException {
		...
		String fileName = "c:/fer/fototecaj.txt";
		
		List<ScheduleEntry> schedule = readEntries(fileName);
		...
		for(ScheduleEntry entry : schedule) {
			...
			String opis = entry.courseName + " (FERKO)";
...
*/
	...
	private static List<ScheduleEntry> readEntries(String fileName) throws IOException {
