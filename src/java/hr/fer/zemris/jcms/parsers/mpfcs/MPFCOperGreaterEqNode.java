...
public class MPFCOperGreaterEqNode extends MPFCBooleanValueNode implements Serializable {
	...
	public MPFCOperGreaterEqNode(MPFCIntValueNode left, MPFCIntValueNode right) {
		super();
		this.left = left;
		this.right = right;
	}
