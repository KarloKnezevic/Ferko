...
public class MPFCOperLessEqNode extends MPFCBooleanValueNode implements Serializable {
	...
	public MPFCOperLessEqNode(MPFCIntValueNode left, MPFCIntValueNode right) {
		super();
		this.left = left;
		this.right = right;
	}
