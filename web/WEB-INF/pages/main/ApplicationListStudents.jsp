...
<p>
 <a href="<s:url action="ApplicationExportList">
 <s:param name="courseInstanceID">
 <s:property value="data.courseInstance.id"/></s:param>
 <s:param name="definitionID">
 <s:property value="data.definition.id"/></s:param>
 <s:param name="format">csv</s:param>
 </s:url>"><s:text name="Export to CSV"/></a> 
|  <a href="<s:url action="ApplicationExportList">
 <s:param name="courseInstanceID">
 <s:property value="data.courseInstance.id"/></s:param>
 <s:param name="definitionID">
 ...
 </s:url>"><s:text name="Export to XLS"/></a> 
</p>
