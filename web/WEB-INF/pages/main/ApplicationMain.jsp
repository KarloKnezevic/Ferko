...
<s:else>
  ...
  <s:iterator value="data.definitions">
	...
	<dd>Razdoblje prijava: <s:date name="openFrom" format="%{getText('locale.datetime')}"/> - <s:date name="openUntil" format="%{getText('locale.datetime')}"/> </dd>
    <s:if test="data.renderCourseAdministration">
	    ...
	    </s:url>"><s:text name="Navigation.applicationEdit"/></a></dd>
	    <dd><a href="<s:url action="ApplicationListStudents">
