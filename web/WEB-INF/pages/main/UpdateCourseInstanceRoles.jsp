...
<s:form action="UpdateCourseInstanceRoles" method="post" theme="ferko">
	...
	<s:textarea name="text" rows="20" cols="100" label="Podaci" />
	<s:select list="tasks" listKey="name" listValue="value" name="task" label="Zadatak" />
