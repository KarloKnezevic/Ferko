...
<s:if test="data.files!=null && data.files.size() != 0">
  <div>Sljedeće datoteke su uploadane na ispit:
    ...
    <s:include value="/WEB-INF/pages/main/assessments/appeals/TypeNotEvaluated.jsp"></s:include>
    <s:include value="/WEB-INF/pages/main/assessments/appeals/TypeNotProcessed.jsp"></s:include>
    <s:include value="/WEB-INF/pages/main/assessments/appeals/TypeNewScore.jsp"></s:include>
    <s:include value="/WEB-INF/pages/main/assessments/appeals/TypeBadEval.jsp"></s:include>
