...
<h2><s:property value="data.parent.name"/><a target="_jcms_help" href="<s:url action="Help"><s:param name="helpKey">000032</s:param></s:url>" onclick="blur();"><img src="img/icons/help.png"></a></h2>
